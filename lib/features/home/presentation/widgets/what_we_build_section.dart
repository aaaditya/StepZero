...
/// Outcome-grouped capabilities — not a service SKU list.
class WhatWeBuildSection extends StatelessWidget {
  const WhatWeBuildSection({super.key});

  static const _groups = <_BuildGroup>[
    _BuildGroup(
      title: 'Brand',
      ...
      child: Column(
        ...
        children: [
          const SectionHeader(
            ...
            title: 'Business systems, not deliverable checklists.',
            subtitle:
                'Four capabilities. One outcome: a local business that feels premium and runs with clarity.',
          ),
              ...
              return Wrap(
                ...
                children: [
                  for (var i = 0; i < _groups.length; i++)
                    SizedBox(
                      width: width,
                      child: _BuildCard(group: _groups[i], index: i),
                    ),
                ],
              );
            },
...
class _BuildCard extends StatelessWidget {
  const _BuildCard({required this.group, required this.index});

  final _BuildGroup group;
  final int index;
